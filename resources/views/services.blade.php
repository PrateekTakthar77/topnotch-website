                ...
                <div class="services__item-three">
                    <div class="services__item-top">
                        ...
                        <div class="services__item-top-title">
                            <h2 class="title">Modern Strategic Business</h2>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="services-grid">
                <div class="services__item-three">
                    ...
                    <h4 class="title">Approval for long-term open Access</h4>
                </div>
                <div class="services__item-three">
                    <div class="services__icon-three">
                        <i class="flaticon-target"></i>
                    </div>
                    <h4 class="title">Approval for short-term open access</h4>
                </div>
                <div class="services__item-three">
                    <div class="services__icon-three">
                        <i class="flaticon-financial-profit"></i>
                    </div>
                    <h4 class="title">Portfolio Management</h4>
                </div>
                <div class="services__item-three">
                    <div class="services__icon-three">
                        <i class="flaticon-target"></i>
                    </div>
                    <h4 class="title">Billing Settlement</h4>
                </div>
                <div class="services__item-three">
                    <div class="services__icon-three">
                        <i class="flaticon-profit"></i>
                    </div>
                    <h4 class="title">Plant to Grid Synchronisation</h4>
                </div>
