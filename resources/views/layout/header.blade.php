		...
		<header class="tg-header__style-two">
			<div class="tg-header__inner-wrap">
				<div class="tg-header__logo-wrap">
					<div class="logo">
						<a href="{{ route('home') }}"><img src="/assets/img/banner/Top-Notch-Logo-1-250x81.png" alt="Logo" /></a>
					</div>
				</div>
										...
										<div class="tgmobile__menu-bottom">
											<div class="contact-info">
												<ul class="list-wrap">
													...
													<li><a href="tel:{{Get_Meta_Tag_Value('General_Settings','Contact_One')}}">{{Get_Meta_Tag_Value('General_Settings','Contact_One')}}</a></li>
												</ul>
											</div>
			...
			<!-- header-search-end -->
				...
				<div class="offCanvas__side-info mb-30">
					...
					<div class="contact-list mb-30">
						...
						<p>+91 {{Get_Meta_Tag_Value('General_Settings','Contact_Two')}}</p>
					</div>
					<div class="contact-list mb-30">
						<h4>{{Get_Meta_Tag_Value('General_Settings','Email_One')}}</h4>
						<p></p>
					</div>
				</div>
